...
export const metadata = {
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.teleringer.com"}/missed-calls`,
  },
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Turn missed calls into real leads and booked jobs. Teleringer's missed calls service helps small businesses stop losing money to unanswered calls.",
            serviceType: "Missed Call Text-Back",
            areaServed: { "@type": "Country", name: "United States" },
            url: `${site}/missed-calls`,
          }),
        }}
      />
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6">
          <div className="mb-12 text-center sm:mb-16">
            <h2 className="mb-4 text-3xl font-bold text-gray-900 sm:text-4xl">
              How the Missed Calls System Works
            </h2>
          </div>
